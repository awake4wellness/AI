...
const pluginRegistry = [
  ...
  { id: "biorresonancia", name: "Biorresonancia", icon: "🧬", color: DS.colors.teal, group: "devices", description: "Reportes y orientación de bienestar", component: () => <PlaceholderPlugin name="Biorresonancia" icon="🧬" description="Pronto: subir el reporte y que Alex te dé orientación de bienestar." coming /> }, { id: "devices", name: "Dispositivos", icon: "🔌", color: DS.colors.primary, group: "devices", description: "Hub de integraciones", component: DevicesPlugin },

...
function PatientDetailPlugin({ patient, sessions, onAddSession, navigate, plugins }) {
  ...
  return (
    <div>
      {verBienvenida && <BienvenidaOverlay patient={patient} C={C} onContinuar={() => setVerBienvenida(false)} />}<button onClick={() => navigate("patients")} style={{ background: "none", border: "none", color: C.muted, cursor: "pointer", fontSize: 13, marginBottom: 20, padding: 0 }}>← Pacientes</button><button onClick={() => setVerBienvenida(true)} style={{ background: "none", border: "none", color: C.teal, cursor: "pointer", fontSize: 13, marginBottom: 20, marginLeft: 14, padding: 0 }}>▶ Bienvenida</button>
